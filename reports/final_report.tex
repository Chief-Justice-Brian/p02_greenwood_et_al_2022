...
For the post-2016 crisis update, the project combines BVX through 2016 with the
Laeven--Valencia IMF systemic-banking-crisis chronology for 2017--2025. The
confirmed post-2016 onsets in that chronology occur outside the paper's
42-country sample; cases labeled borderline are excluded. Consequently, the
updated regressions gain documented non-crisis outcomes but no new systemic
onset within this country universe.
...
recalculated value under a pre-documented absolute tolerance. All 586 checks
pass. This means the reconstruction is acceptably close for the intended
public-data replication; it does not mean every cell is numerically identical.}
...
\small
\input{../_output/table1_updated.tex}
\end{table}
...
\begin{figure}[p]
\centering
\includegraphics[width=0.96\textwidth]{../_output/updated_business_rzone_timeline.png}
\caption{\textbf{Updated Figure 1: event history through 2025.} Historical BVX
crises are joined to the later IMF systemic-crisis chronology, and business
...
\ContinuedFloat
\centering
\includegraphics[width=0.96\textwidth]{../_output/updated_household_rzone_timeline.png}
...
\input{../_output/table4_updated.tex}
\end{landscape}

\begin{figure}[H]
\centering
\includegraphics[width=0.90\textwidth]{../_output/figure3_fraction_countries_rzone_updated.jpg}
...
high leverage measures one at a time, plus their interaction with the sector
R-Zone. All comparisons use the same complete-case sample as the corresponding
...
measures and sectors. The extension therefore offers evidence that bank-side
conditions matter independently, but not a robust claim that they universally
amplify R-Zone booms.
...
80th percentile, six have high loans-to-deposits, and five have high leverage.
...
every horizon, most visibly at the one- and two-year horizons. The R-Zone
coefficient generally remains positive but changes in magnitude and precision.
Because the AUC values are in-sample, the exercise establishes incremental fit
rather than a definitive out-of-sample forecasting gain.
...
historical benchmarks pass their stated tolerances, and the full automated test
suite verifies the main growth, threshold, outcome-window, sample, and updated
coverage rules. The post-publication work recalculates rather than merely
...
complete crisis model. Bank fragility and crisis memory add information, while
...
Laeven, Luc, and Fabi\'an Valencia. 2026. ``Systemic Banking Crises Database:
1970--2025.'' IMF Working Paper 26/94.
